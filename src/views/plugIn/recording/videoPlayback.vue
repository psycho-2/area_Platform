...
<template>
  <div class="wrapper">
    <!-- header -->
    <div class="title">
      <em @click="back" class="back"></em>视频播放
    </div>
    <!-- content -->
    <div class="content">
        <div class="showPhoto">
        ...
        <input type="button" class="Sender" id="btn3" value='Native播放器' @click="nativePlayer">
    </div>
  </div>
</template>
...
module.exports = {
  ...
  methods: {
    ...
    nativePlayer: function() {
      var _this = this;
      try {
        cordova.plugins.AresMultimedia.playVideo('http://mp4.vjshi.com/2017-07-10/eba927665d764ba2b762fdcaa29c02f4.mp4', successCallback, errorCallback);

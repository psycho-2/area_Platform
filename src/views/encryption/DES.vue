<template>
  <div class="wrapper">
    <!-- header -->
    <div class="title">
      <em @click="backEncryption" class="back"></em>DES
    </div>
    <!-- content -->
    <div class="content">
        <!-- 单选框 -->
        <div class="checkbox">
          <span @click="onDESClick(3)" :class="['DES',this.DES == 3 ? 'active' : '']" id="btn4" >DES</span>
          <span @click="onDESClick(4)" :class="['DES',this.DES == 4 ? 'active' : '']" id="btn4">3DES</span>
        </div>
        <!-- 加密因子 -->
        <!-- <div class="source">
          <label class="string">加密因子：</label>
          <div class="col-sm-4">
            <input type="text" class="bgWhite" readonly="readonly" id="get_cardpwd" :value="factor">
        ...
        <div class="result">
          ...
          <div class="col-sm-4">
            <textarea type="text" readonly="readonly" :value="decryptString" class="bgWhite" id="get_cardpwd"></textarea>
          </div>
        </div>
    </div>
  </div>

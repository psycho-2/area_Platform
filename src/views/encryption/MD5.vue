<template>
  <div class="wrapper">
    <!-- header -->
    <div class="title">
      <em @click="backEncryption" class="back"></em>MD5
    </div>
    <!-- content -->
    <div class="content">
        <p class="header">字符串加密</p>
        <!-- 源字符串: -->
        <div class="source">
        ...
        <!-- 解密 -->
        <p class="header">文件MD5值</p>
        <!-- 文件路径 -->
        <div class="filePath">
            <label for="get_prof" class="control-label">文件路径：</label>
            <div class="col-sm-4">
              <input type="bottom" class="input-sm" id="get_prof" :value="filePath">
              <!-- <select class="input-sm" id="get_prof">
                  <option value = '0'>./images/a.png</option>
                  <option value = '1'>./images/b.png</option>
              </select> -->
            </div>
        </div>
        ...
        <div class="result">
          <label class="string">结果字符串：
            <input type="button" class="bgGray" id="btn4" value='MD5值' @click="MD5Value">
          </label>
          <div class="col-sm-4">
            <textarea type="text" readonly="readonly" :value="MD5resultStr" class="bgWhite" id="get_cardpwd" ></textarea>
          </div>
        </div>
    </div>
  </div>
